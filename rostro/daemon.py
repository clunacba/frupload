...
def msg(devid,name, img):
	...
	d={"deviceid":devid,"Nombre Rostro":name, "Alerta":"Ingreso"}
	return json.dumps(d)
...
#rtsp = "rtsp://Cordiez:Cordiez1234@192.168.44.213:554/cam/realmonitor?channel=1&subtype=1"
...
while start:
	...
	for ((top, right, bottom, left), name) in zip(boxes, names):
		...
		if actual1 > mas100+6:
			if nombre != "Unknown":
				sendalert("cord00000002", nombre, "ng.drexgen.com","cordiez/ai/fr/001", frame)
				print ("bbbb")
				#band = True
				mas100=actual1
