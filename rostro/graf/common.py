...
def draw_strApe(dst, target, s,color):
    x, y = target
    cv.putText(dst, s, (x, y), cv.FONT_HERSHEY_PLAIN, 2, color, 2,lineType=cv.LINE_AA)    
...
def draw_rects(img, rects, color):
    ...
    for y1, x1, y2, x2 in rects:
        ...
        cv.line(img, arriba_1, arriba_2, color1, anchoLinea)          # |
        cv.line(img, abajo_1, abajo_2, color1, anchoLinea)            # |
        cv.line(img, izquierda_1, izquierda_2, color1, anchoLinea)    # ─
        cv.line(img, derecha_1, derecha_2, color1, anchoLinea)        # ─
    ...
    #    cv.line(img, cruzorizontal_1, cruzorizontal_2, color, anchoLinea1)        # ─
        ...
        #centro
        cv.line(img, centroizquierda_arriba_1, centroizquierda_arriba_2, color, anchoLinea1)  # | centro izquierda arriba
        cv.line(img, centroizquierda_abajo_1, centroizquierda_abajo_2, color, anchoLinea1)  # | centro izquierda abajo
        cv.line(img, centroderecha_arriba_1, centroderecha_arriba_2, color, anchoLinea1)  # | centro derecha arriba
        cv.line(img, centroderecha_abajo_1, centroderecha_abajo_2, color, anchoLinea1)  # | centro derecha abajo

        cv.line(img, centroizquierda_arriba1_1, centroizquierda_arriba1_2, color, anchoLinea1)  # | centro izquierda arriba
        cv.line(img, centroizquierda_abajo1_1, centroizquierda_abajo1_2, color, anchoLinea1)  # | centro izquierda abajo
        cv.line(img, centroderecha_arriba1_1, centroderecha_arriba1_2, color, anchoLinea1)  # | centro derecha arriba
        cv.line(img, centroderecha_abajo1_1, centroderecha_abajo1_2, color, anchoLinea1)  # | centro derecha abajo
